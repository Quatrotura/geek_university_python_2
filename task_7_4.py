...
# {100000: 902, 1000: 10, 0: 1, 10000: 87}

# прощупывание логики через ручками созданный словарь
# files_size_info = {
#                     0: 0,
#                     10: 0,
#                     100: 0, 
...
#     if os.path.isfile(file):
#       file_size = file.stat().st_size
#       for key in files_size_info.keys():
#         if file_size < key:
#           files_size_info[key] += 1
#           break
#     else:
#       get_file_size(os.path.join(path, file.name))
...
# print(files_size_info)

# # {100: 1, 1000: 10, 10000: 87, 100000: 902}
